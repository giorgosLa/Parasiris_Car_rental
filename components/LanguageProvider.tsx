...
const translations: Translations = {
  en: {
    ...
    "booking.totalPrice": "Total Price: €{{amount}}",
    "fleet.title": "Our Fleet",
    "fleet.empty": "No vehicles found in the database.",
    "fleet.tag": "Premium Selection",
    "fleet.subtitle":
      "Discover our curated lineup of reliable, fully serviced vehicles ready for island trips, airport transfers, and city escapes.",
    "car.available": "Available",
    "car.unavailable": "Unavailable",
    "car.seats": "{{count}} seats",
    "car.year": "Year {{year}}",
    "car.license": "Plate: {{plate}}",
    "car.daily": "Daily: €{{price}}",
    "car.status": "Status: {{status}}",
    "car.fuel": "Fuel: {{fuel}}",
    "car.transmission": "Transmission: {{transmission}}",
    "footer.location.herAirport": "Heraklion Airport (HER)",
    "footer.location.chnAirport": "Chania Airport (CHQ)",
    "footer.location.herPort": "Heraklion Port",
    "footer.location.rethymno": "Rethymno Center",
    "footer.copy": "© 2025 Easy Rental - Parasiris. All rights reserved.",
    "searchbar.title": "Plan your trip",
    "searchbar.subtitle": "Pick locations, dates and time to see instant availability.",
    "hero.badge": "Premium rentals · 24/7 Support · Island & Airport Delivery",
  ...
  el: {
    ...
    "booking.totalPrice": "Συνολικό ποσό: €{{amount}}",
    "fleet.title": "Ο στόλος μας",
    "fleet.empty": "Δεν βρέθηκαν οχήματα στη βάση.",
    "fleet.tag": "Premium επιλογή",
    "fleet.subtitle":
      "Εξερεύνησε τον προσεκτικά επιλεγμένο στόλο μας, συντηρημένο και έτοιμο για ταξίδια, αεροδρόμια και αποδράσεις στην πόλη.",
    "car.available": "Διαθέσιμο",
    "car.unavailable": "Μη διαθέσιμο",
    "car.seats": "{{count}} θέσεις",
    "car.year": "Έτος {{year}}",
    "car.license": "Πινακίδα: {{plate}}",
    "car.daily": "Ημερήσια: €{{price}}",
    "car.status": "Κατάσταση: {{status}}",
    "car.fuel": "Καύσιμο: {{fuel}}",
    "car.transmission": "Κιβώτιο: {{transmission}}",
    "footer.location.herAirport": "Αεροδρόμιο Ηρακλείου (HER)",
    "footer.location.chnAirport": "Αεροδρόμιο Χανίων (CHQ)",
    "footer.location.herPort": "Λιμάνι Ηρακλείου",
    "footer.location.rethymno": "Κέντρο Ρεθύμνου",
    "footer.copy": "© 2025 Easy Rental - Parasiris. Με επιφύλαξη παντός δικαιώματος.",
    "searchbar.title": "Οργάνωσε το ταξίδι σου",
    "searchbar.subtitle": "Διάλεξε τοποθεσίες, ημερομηνίες και ώρες για άμεση διαθεσιμότητα.",
    "hero.badge": "Premium ενοικιάσεις · 24/7 Υποστήριξη · Παραδόσεις σε νησιά & αεροδρόμια",
